...
/**
 * 默认的表情(中文名称的字段还是很少见的,但是没有合适的英文名称)
 * 注: id并不连续,我也不知道为什么
 */
public enum Face implements MessageImpl
{
    惊讶(0),
    撇嘴(1),
    色(2),
    ...
    private static final Face[] faces=new Face[325];
    ...
    {
        return new net.mamoe.mirai.message.data.Face(id);
    }
}
